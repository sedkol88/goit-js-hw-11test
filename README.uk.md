...
(async () => { const browser = await puppeteer.launch(); const page = await
browser.newPage(); await page.goto('https://example.com'); // Замените на URL
вашего сайта

// Здесь вы можете использовать методы page для взаимодействия с формой. await
page.type('#name', 'John Doe'); await page.type('#email',
'john.doe@example.com'); await page.click('#submit'); // Замените на селектор
